...
- Name: 分岐管理機能テスト >> 分岐作成機能のテスト
- Location: C:\Users\kinoko\shogi_gui\frontend\tests\branch-management.spec.ts:55:3
...
Call log:
  - waiting for locator('.create-branch-btn')
    ...
    at C:\Users\kinoko\shogi_gui\frontend\tests\branch-management.spec.ts:59:16
```

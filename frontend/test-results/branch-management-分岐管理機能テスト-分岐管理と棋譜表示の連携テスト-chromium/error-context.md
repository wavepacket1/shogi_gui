...
- Name: 分岐管理機能テスト >> 分岐管理と棋譜表示の連携テスト
- Location: C:\Users\kinoko\shogi_gui\frontend\tests\branch-management.spec.ts:206:3
...
Call log:
  - waiting for locator('.create-branch-btn')
    ...
    at C:\Users\kinoko\shogi_gui\frontend\tests\branch-management.spec.ts:213:16
```

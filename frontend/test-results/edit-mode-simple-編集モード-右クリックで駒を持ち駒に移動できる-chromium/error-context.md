...
- Name: 編集モード >> 右クリックで駒を持ち駒に移動できる
- Location: C:\Users\kinoko\shogi_gui\frontend\tests\edit-mode-simple.spec.ts:53:3
...
Expected: > 0
Received:   0
    at C:\Users\kinoko\shogi_gui\frontend\tests\edit-mode-simple.spec.ts:84:34
```
...
- button "手番切り替え"
- button "保存"
- text: "ゲームID: 2126 香 桂 銀 金 玉 金 銀 桂 香 飛 角 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 歩 角 飛 香 桂 銀 金 王 金 銀 桂 香"

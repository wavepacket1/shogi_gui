...
- Name: 分岐管理機能テスト >> キャンセル操作のテスト
- Location: C:\Users\kinoko\shogi_gui\frontend\tests\branch-management.spec.ts:189:3
...
Call log:
  - waiting for locator('.create-branch-btn')
    ...
    at C:\Users\kinoko\shogi_gui\frontend\tests\branch-management.spec.ts:193:16
```

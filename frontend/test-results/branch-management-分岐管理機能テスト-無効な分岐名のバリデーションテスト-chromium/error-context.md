...
- Name: 分岐管理機能テスト >> 無効な分岐名のバリデーションテスト
- Location: C:\Users\kinoko\shogi_gui\frontend\tests\branch-management.spec.ts:143:3
...
Call log:
  - waiting for locator('.create-branch-btn')
    ...
    at C:\Users\kinoko\shogi_gui\frontend\tests\branch-management.spec.ts:147:16
```
